...
- Не формирует медицинский ответ, если обязательные RU/EN веб-источники не найдены
- Не разрешает модели дополнять рекомендации сведениями из собственной памяти без источника
